...
// Schema Creation for Order model
...
app.post('/placeorder', fetchUser, async (req, res) => {
    try {
        ...
        // Create an array to hold the ordered products
        const orderedProducts = [];

        // Loop through the cart data and add each product to the ordered products array
        ...
        if (orderedProducts.length === 0) {
            return res.status(400).json({ success: false, error: "No products found in the cart" });
        }

        // Create the order and include the ordered products
        ...
        // Clear the user's cart data in the database
...
/* 
// Endpoint for updating additional profile details
app.post('/updateprofile', async (req, res) => {
    try {
        ...
        user.middleName = req.body.firstName || user.middleName;
...
// Endpoint for fetching order history
